...
public class Main {
    ...
    @FXML private TableColumn<Zimi_Mstr, Date> zimiRcpdateColumn;
    ...
    @FXML private TableColumn<Zimi_Mstr, Date> rcpdateColumnEx;
    ...
    public void initialize() {
        ...
        zimiRcpdateColumn = ViewTable.createColumn("Rcpdate", record -> record.getzIMI_Rcpdate());
        ...
        rcpdateColumnEx = ViewTable.createColumn("Rcpdate", record -> record.getzIMI_Rcpdate());
